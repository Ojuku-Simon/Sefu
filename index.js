...
document.getElementById('contactForm').addEventListener('submit', function(event) {
    ...
    confirmationMessage.textContent = `Thank you, ${name}! Your message has been submitted.`;
...
// Sample offers data
const offersData = [
    { title: 'Special Pizza Deal', description: 'Buy one large pizza and get one medium pizza free!', price: '$19.99', image: 'pizza.jpg' },
    { title: 'Burger Combo Offer', description: 'Get a burger, fries, and a drink for only $9.99!', price: '$9.99', image: 'burger.jpg' },
    { title: 'Family Pasta Night', description: 'Family-sized pasta with garlic bread and salad for just $24.99!', price: '$24.99', image: 'pasta.jpg' }
];
